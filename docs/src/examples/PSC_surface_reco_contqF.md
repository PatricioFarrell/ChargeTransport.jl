# xxx
([source code](https://github.com/PatricioFarrell/ChargeTransportInSolids.jl/tree/master/examplesPSC_surface_reco_contqF.jl))
...
```julia
module PSC_surface_reco_contqF
...
```julia
    ...
    ################ data for suface recombination ################
    data.bBandEdgeEnergy[iphin, bregionJunction1] = 0.5 * ( data.bandEdgeEnergy[iphin, regionAcceptor] + data.bandEdgeEnergy[iphin, regionIntrinsic] )
    data.bBandEdgeEnergy[iphip, bregionJunction1] = 0.5 * ( data.bandEdgeEnergy[iphip, regionAcceptor] + data.bandEdgeEnergy[iphip, regionIntrinsic] )

    data.bDensityOfStates[iphin, bregionJunction1] = 0.5 * ( data.densityOfStates[iphin, regionAcceptor] + data.densityOfStates[iphin, regionIntrinsic] )
    data.bDensityOfStates[iphip, bregionJunction1] = 0.5 * ( data.densityOfStates[iphip, regionAcceptor] + data.densityOfStates[iphip, regionIntrinsic] )

    data.bBandEdgeEnergy[iphin, bregionJunction2] = 0.5 * ( data.bandEdgeEnergy[iphin, regionIntrinsic] + data.bandEdgeEnergy[iphin, regionDonor] )
    data.bBandEdgeEnergy[iphip, bregionJunction2] = 0.5 * ( data.bandEdgeEnergy[iphip, regionIntrinsic] + data.bandEdgeEnergy[iphip, regionDonor] )

    data.bDensityOfStates[iphin, bregionJunction2] = 0.5 * ( data.densityOfStates[iphin, regionIntrinsic] + data.densityOfStates[iphin, regionDonor] )
    data.bDensityOfStates[iphip, bregionJunction2] = 0.5 * ( data.densityOfStates[iphip, regionIntrinsic] + data.densityOfStates[iphip, regionDonor] )

    data.recombinationSRHvelocity[iphin,     bregionJunction1] = 1.0e+1 * cm/s
    data.recombinationSRHvelocity[iphip,     bregionJunction1] = 1.0e+7 * cm/s
    data.brecombinationSRHTrapDensity[iphin, bregionJunction1]  = ChargeTransportInSolids.trapDensity(iphin, regionIntrinsic, data, EI[regionAcceptor])
    data.brecombinationSRHTrapDensity[iphip, bregionJunction1]  = ChargeTransportInSolids.trapDensity(iphip, regionIntrinsic, data, EI[regionAcceptor])

    data.recombinationSRHvelocity[iphin,     bregionJunction2] = 1.0e+7 * cm/s
    data.recombinationSRHvelocity[iphip,     bregionJunction2] = 1.0e+1 * cm/s
    data.brecombinationSRHTrapDensity[iphin, bregionJunction2]  = ChargeTransportInSolids.trapDensity(iphin, regionDonor, data, EI[regionIntrinsic])
    data.brecombinationSRHTrapDensity[iphip, bregionJunction2] = ChargeTransportInSolids.trapDensity(iphip, regionDonor, data, EI[regionIntrinsic])
...
```julia
    ...
    breaction   = ChargeTransportInSolids.breactionOhmicSurfaceReco!,
...
```julia
        ...
        Plotter.plot(biasValuesForward, IVForward.*(cm^2), label = "simulation",  linewidth= 3, linestyle="--", color="red")
