"""
Simulating charge transport in a GAs pin diode with variable band-edge energies.
"""

module VariableBandEdges
...
println("This message should show when the variable band-edges module is successfully recompiled.")
end # module
