...
# ## function to initialize the grid for a possble extension to other p-i-n devices.
# function initialize_pin_grid(refinementfactor, h_pdoping_left, h_pdoping_left, h_pdoping_trap, h_pdoing_right)
#     coord_pdoping_left    = collect(range(0.0, stop = h_pdoping_left, length = 2 * refinementfactor))
#     coord_pdoping_right  = collect(range(h_pdoping_left, stop = (h_pdoping_left + h_pdoping_left), length = 3 * refinementfactor))
#     coord_pdoping_plus  = collect(range((h_pdoping_left + h_pdoping_left), 
#                                         stop = (h_pdoping_left + h_pdoping_left + h_pdoping_trap), 
#                                         length =  refinementfactor))
#     coord_pdoping_right = collect(range((h_pdoping_left + h_pdoping_left + h_pdoping_trap), 
#                                         stop = (h_pdoping_left + h_pdoping_left + h_pdoping_trap + h_pdoing_right), 
...
#     regions             = [regionAcceptorLeft, regionAcceptorRight, regionAcceptorTrap, regionAcceptorRight]
#     numberOfRegions     = length(regions)

#     ## boundary region numbers
#     bregionAcceptorRight            = 1
#     bregionAcceptorLeft         = 2
#     bregions                = [bregionAcceptorRight, bregionAcceptorLeft]
#     numberOfBoundaryRegions = length(bregions)
...
#     cellmask!(grid, [h_pdoping_left], [h_pdoping_left + h_pdoping_left], regionAcceptorRight)    
#     ## p doped with traps
#     cellmask!(grid, [h_pdoping_left + h_pdoping_left], [h_pdoping_left + h_pdoping_left + h_pdoping_trap], regionAcceptorTrap)  
#     ## p doped
#     cellmask!(grid, [h_pdoping_left + h_pdoping_left + h_pdoping_trap], [h_pdoping_left + h_pdoping_left + h_pdoping_trap + h_pdoing_right], regionAcceptorRight)   
...
#     ## In this application ion vacancies only live in active perovskite layer
#     data.boundary_type[bregionAcceptorLeft] = schottky_contact                       
#     data.boundary_type[bregionAcceptorRight]    = ohmic_contact    
...
#     params.bBandEdgeEnergy[iphin, bregionAcceptorRight]         = Ec_ZnO
#     params.bBandEdgeEnergy[iphip, bregionAcceptorRight]         = Ev_ZnO
#     params.bBandEdgeEnergy[iphin, bregionAcceptorRight]         = Ec_CIGS
#     params.bBandEdgeEnergy[iphip, bregionAcceptorRight]         = Ev_CIGS

#     # only CIGS regions
#     for ireg in [regionAcceptorRight, regionAcceptorTrap, regionAcceptorRight]          
...
#     params.mobility[iphin, regionAcceptorLeft] = mun_ZnO
#     params.mobility[iphip, regionAcceptorLeft] = mup_ZnO
#     params.mobility[iphit, regionAcceptorLeft] = mut
#     params.dielectricConstant[regionAcceptorLeft] = εr_ZnO
#     params.bandEdgeEnergy[iphin, regionAcceptorLeft] = Ec_ZnO
#     params.bandEdgeEnergy[iphip, regionAcceptorLeft] = Ev_ZnO
#     params.recombinationSRHTrapDensity[iphin, regionAcceptorLeft] = n0_ZnO
...
#     # params.generationUniform[regionAcceptorLeft]          = 0.0
#     # params.generationUniform[regionAcceptorRight]   = G
#     # params.generationUniform[regionAcceptorTrap]   = G
#     # params.generationUniform[regionAcceptorRight]  = G
#     params.generationAbsorption[regionAcceptorLeft]          = A_ZnO
#     params.generationIncidentPhotonFlux[regionAcceptorLeft]  = N0
...
#     ## doping -- since we do not set any doping for the traps it is automatically zero
#     params.doping[iphin, regionAcceptorLeft]                   = Nd        
#     params.doping[iphip, regionAcceptorRight]            = Na        
#     params.doping[iphip, regionAcceptorTrap]            = Na        
#     params.doping[iphip, regionAcceptorRight]           = Na

#     ## boundary doping
#     params.bDoping[iphin, bregionAcceptorRight]                 = Nd        
#     params.bDoping[iphip, bregionAcceptorLeft]              = Na   
    
#     ## values for the schottky contacts
#     params.SchottkyBarrier[bregionAcceptorLeft]             = barrier
#     params.bVelocity[iphin,bregionAcceptorLeft]             = vn 
#     params.bVelocity[iphip,bregionAcceptorLeft]             = vp 
